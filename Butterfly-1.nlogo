globals []
; q = probability of hilltopping behavior. I am tinkering, can we make a q slider?
patches-own [elevation]
turtles-own []

to setup
  ca
  ; Initialize patches with sinusoidal elevation (3.8 factor makes there be about two peaks from 0 to 150). N.B. sin takes input with degrees :(
  ask patches
  [
    set elevation 200 + (100 * (sin (pxcor / max-pxcor * 360 * 1.5 ) + sin (pycor / max-pycor * 360 * 1.5 )))
    set elevation elevation + random-float 10
